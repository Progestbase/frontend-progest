        ...
        <ModalBase01 :id="idModal" modalClass="modal-dialog modal-lg modal-dialog-centered">
            ...
            <div class="com-md-12">
                <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="aba_dados" role="tabpanel"
                        aria-labelledby="aba_dados-tab">
                        <form autocomplete="off">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        <label class="form-label" for="TipoUsuarioNome">Nome</label>
                                        <input type="text" class="form-control text-uppercase" placeholder=""
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="TipoUsuario.descricao" class="form-label">Descrição</label>
                                        <input type="text" class="form-control text-uppercase" placeholder=""
            ...
            <div class="row mmt-2">
                <div class="col-12 text-end">
                    ...
                    <button type="submit" class="btn btn-success" data-bs-target="#success-btn" id="btn-save-event"
                        v-on:click="add_UP_Tipos_Usuario()"><i class="mdi mdi-check-bold font-size-15"></i> {{
...
import Funcoes from "@/functions/cad_tipos_usuario.js";

export default {
    name: 'ModalTiposUsuario',
    components: {
        ModalBase01,
        Funcoes
    },
