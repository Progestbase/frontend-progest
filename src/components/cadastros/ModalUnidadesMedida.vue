                    ...
                    <div class="tab-pane fade show active" id="aba_dados" role="tabanel"
                        ...
                        <form autocomplete="off">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        <label class="form-label" for="unidadeMedidaNome">Nome</label>
                                        <input type="text" class="form-control text-uppercase" id="unidadeMedidaNome"
                                            placeholder="" v-model="modalData.nome">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label" for="unidadeMedidaStatus">Status</label>
                                        <select class="form-select" id="unidadeMedidaStatus" v-model="modalData.status">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label" for="unidadeMedidaDescricao">Descrição</label>
                                            <input type="text" class="form-control" id="unidadeMedidaDescricao" placeholder=""
            ...
            <div class="row mmt-2">
                <div class="col-12 text-end">
                    ...
                    <button type="submit" class="btn btn-success" data-bs-target="#success-btn" id="btn-save-event"
                        v-on:click="add_UP_Unidades_Medida()"><i class="mdi mdi-check-bold font-size-15"></i> {{
