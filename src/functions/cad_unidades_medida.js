var ADD_UP = (content, funcao) => {
    content.$axios
        .post(
            funcao == "ADD" ? "/unidadesMedida/add" : "/unidadesMedida/update",
            {
                unidadesMedida:
                    funcao == "ADD" || funcao == "UP"
                        ? content.modalData
                        : content.unidadesMedida_data
            },
            {
                headers: {
...
var listAll = (content, url = null) => {
    ...
    content.$axios
        .post(
            url == null ? "/unidadesMedida/list" : url,
            {
        ...
        .then(response => {
            content.$store.commit("setListUnidadesMedida", response.data);
            console.log("setListUnidadesMedida", response.data.data);
...
var update = (content) => {
    content.$axios
        .post(
            ...
            {
                unidadesMedida: content.modalData
            },
            {
                headers: {
                    Authorization: "Bearer " + content.$store.getters.getUserToken
