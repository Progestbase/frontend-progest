  ...
  <div>
    ...
    <div v-else-if="unidadeEstoque && estoqueItems.length >= 0">
      ...
      <div class="row mb-4">
        <div class="col-12">
          <h5 class="mb-3">
            ...
            <span
              v-if="unidadeEstoque.nome === 'Unidade Exemplo'"
      ...
      <div v-else class="text-center py-5">
        ...
        <p class="text-muted">
          Esta unidade ainda não possui produtos em estoque.
        </p>
      </div>
    </div>

    <!-- Mensagem quando unidade não tem estoque -->
    <div v-else class="text-center py-5">
      <i class="mdi mdi-information-outline display-4 text-info mb-3"></i>
      <h5>Esta unidade não possui controle de estoque</h5>
      <p class="text-muted">
        Para habilitar o controle de estoque, edite a unidade e marque a opção
        "Controle de Estoque".
      </p>
    </div>
...
export default {
  ...
  methods: {
    async carregarEstoque() {
      ...
      try {
        await functions.listEstoqueUnidade(this, this.unidadeId);
      } catch (error) {
