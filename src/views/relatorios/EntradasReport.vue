            ...
            <div class="card-body">
              <div class="row g-2">
                ...
                <div class="col-md-4 d-flex align-items-end justify-content-end">
                  <button class="btn btn-outline-success me-2" @click="exportCsv" :disabled="entries.length===0">Exportar CSV</button>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    exportCsv() {
      ...
      a.href = url;
      a.download = `relatorio_entradas_${new Date().toISOString().slice(0,10)}.csv`;
      a.click();
